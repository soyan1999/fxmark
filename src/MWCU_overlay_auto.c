...
static int pre_work(struct worker *worker)
{
    ...
    sprintf(cmd, "sudo /home/xiaoli7/soyan/fxmark/auto_mount/auto_mount_client.py mount %s/mount_point", test_root);
...
static int post_work(struct worker *worker) {
    ...
    set_test_root(worker, test_root);
    sprintf(cmd, "sudo /home/xiaoli7/soyan/fxmark/auto_mount/auto_mount_client.py umount %s/mount_point", test_root);
    if (system(cmd)!=0) goto err_out;
